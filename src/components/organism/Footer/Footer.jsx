...
const Footer = () => {
    return (
        <footer>
            <div className={'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-12 lg:gap-y-20'}>
                ...
                <div className={'about col-span-1 lg:col-span-2'}>
                    <h3>about us</h3>
                    <p className={'mb-4'}>A community that dares to pursue its dreams beyond its limits.</p>
                    <div>
                        <i className="fa-brands fa-youtube"></i>
                        <i className="fa-brands fa-instagram"></i>
                    </div>
                </div>
                <div className={'newsletter md:col-span-2 lg:col-span-1'}>
                    <h3>-10% on your first order</h3>
                    <p className={'mb-4'}>Receive our new releases in advance and join the Be Lost adventure.</p>
                    <Input placeholderContent={'email'} />
                </div>
                <div className={'copyright col-span-1 lg:col-span-2 order-last md:order-none'}>
                    <p>© 2024 Saphiir - Website created by Pierre Sénéchal</p>
                </div>
                <div className={"payment grid grid-cols-subgrid gap-4 col-span-1 lg:col-span-2"}>
                    <div className="col-start-3 flex gap-2">
                        <svg className="section-footer__payment-icon" viewBox="0 0 38 24"
                        ...
                        <svg className="section-footer__payment-icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg className="section-footer__payment-icon" xmlns="http://www.w3.org/2000/svg" role="img"
